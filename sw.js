...
const CORE_SHELL = [
  './', './index.html', './game.html', './auth.html', './auth-cache-recovery.js?v=0.10.964', './hosting-origin-guard.js', './viewport-shell.css', './viewport-shell.js', './styles.css',
  './manifest.webmanifest', './quiz-event-v2.css?v=0.10.964', './tropical-shop-approved-ui.css?v=0.10.964', './oyatsu-daisuki-approved-ui.css?v=0.10.964', './white-bunny-tonkatsu-event.css?v=0.10.964', './js/app.js?v=0.10.964', './js/events/white-bunny-tonkatsu-event.js?v=0.10.964', './js/finance/store-rent.js?v=0.10.964', './js/store/display-shop.js?v=0.10.964', './js/finance/home-property.js?v=0.10.964', './js/finance/home-property-controller.js?v=0.10.964', './js/runtime/lazy-modules.js?v=0.10.964', './js/runtime/finished-video-cache-warm.js?v=0.10.964', './js/ui/winter-cold-text-effect.js?v=0.10.964', './js/ui/toast-presenter.js?v=0.10.964', './js/ui/modal-presenter.js?v=0.10.964', './js/ui/autosave-status-presenter.js?v=0.10.964', './js/ui/clipboard-fallback.js?v=0.10.964', './js/ui/gift-labels.js?v=0.10.964', './js/ui/craft-surface.js?v=0.10.964', './js/ui/press-hold-controller.js?v=0.10.964', './js/events/event-state-helpers.js?v=0.10.964', './js/events/bulldog-store-assessment-rules.js?v=0.10.964', './js/events/bulldog-store-assessment-event.js?v=0.10.964', './assets/images/events/bulldog-store-assessment.png', './js/events/robot-store-assessment-rules.js?v=0.10.964', './js/events/robot-store-assessment-event.js?v=0.10.964', './assets/images/events/store-assessment-robot.png', './js/audio.js?v=0.10.964', './js/audio-scene-map.js?v=0.10.964', './js/game-data.js?v=0.10.964', './js/memories-screen.js?v=0.10.964', './js/memories-backgrounds.js?v=0.10.964', './js/daily-gems-index.js?v=0.10.964',
  './js/events/retro-battle-frame-loader.js?v=0.10.964',
  './js/aquarium/tropical-shop-approved-ui.js?v=0.10.964',
  './js/events/oyatsu-daisuki-approved-ui.js?v=0.10.964',
  './js/ui/tool-brief.js?v=0.10.964',
  ...
  './js/ui/workshop-staff-quality-description.js?v=0.10.964',
  './js/ui/workshop-loose-display-name.js?v=0.10.964',
  './js/ui/metal-market-date-label.js?v=0.10.964',
  './js/ui/metal-price-date-label.js?v=0.10.964',
  './js/ui/phone-item-effect-text.js?v=0.10.964',
  './js/ui/save-diagnostic-date-label.js?v=0.10.964',
  './js/ui/save-diagnostic-bytes-label.js?v=0.10.964',
  './js/ui/save-diagnostic-capacity-label.js?v=0.10.964',
  './js/ui/birthday-japanese-label.js?v=0.10.964',
  './js/ui/game-date-label.js?v=0.10.964',
  './js/ui/finance-row-date-label.js?v=0.10.964',
  './js/ui/notification-date-label.js?v=0.10.964',
  './js/ui/customer-preference-label.js?v=0.10.964',
  './js/ui/customer-template-text.js?v=0.10.964',
  './js/ui/store-display-name.js?v=0.10.964',
  './js/ui/artisan-title.js?v=0.10.964',
  './js/ui/loose-display-label.js?v=0.10.964',
  './js/ui/install-status-text.js?v=0.10.964',
  './js/ui/metal-weight-label.js?v=0.10.964',
  './js/aquarium/axolotl.js',
  './js/japan-holidays.js', './js/firebase-config.js',
  './js/google-auth-bridge.js?v=0.10.964', './js/security-config.js', './js/firebase-service.js?v=0.10.964', './js/local-save-storage.js?v=0.10.964',
