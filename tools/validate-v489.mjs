...
assert(VERSION === '0.10.489', `VERSIONが0.10.489ではありません: ${VERSION}`);
assert(DEFAULT_BIRTHDAY === '04-01', '誕生日の既定値が4月1日ではありません');
assert(sw.includes("const VERSION = '0.10.489'"), 'Service WorkerのVERSIONが古いです');
assert(indexHtml.includes('game.html?v=0.10.489'), 'index.htmlの読込番号が古いです');
assert(gameHtml.includes('js/app.js?v=0.10.489'), 'game.htmlの読込番号が古いです');
assert(app.includes("./daily-gems.js?v=0.10.489"), 'daily-gemsの読込番号が古いです');
...
console.log('v0.10.489 年末年始の体調不良停止期間検査: OK');
...
// v0.10.489: user-provided tool image implementation.
...
console.log(`v0.10.489 validation passed: ${toolImagesV486.length} tool images implemented including buffer.png.`);
