...
const CORE_SHELL = [
  './', './index.html', './game.html', './auth.html', './auth-cache-recovery.js?v=0.10.888', './hosting-origin-guard.js', './viewport-shell.css', './viewport-shell.js', './styles.css',
  './manifest.webmanifest', './quiz-event-v2.css?v=0.10.888', './js/app.js?v=0.10.888', './js/runtime/lazy-modules.js?v=0.10.888', './js/runtime/finished-video-cache-warm.js?v=0.10.888', './js/ui/winter-cold-text-effect.js?v=0.10.888', './js/ui/toast-presenter.js?v=0.10.888', './js/ui/modal-presenter.js?v=0.10.888', './js/ui/autosave-status-presenter.js?v=0.10.888', './js/ui/clipboard-fallback.js?v=0.10.888', './js/ui/gift-labels.js?v=0.10.888', './js/ui/craft-surface.js?v=0.10.888', './js/ui/press-hold-controller.js?v=0.10.888', './js/audio.js?v=0.10.888', './js/audio-scene-map.js?v=0.10.888', './js/game-data.js?v=0.10.888', './js/memories-screen.js?v=0.10.888', './js/memories-backgrounds.js?v=0.10.888', './js/daily-gems-index.js?v=0.10.888',
  './js/ui/tool-brief.js?v=0.10.888',
  './js/ui/store-branch-label.js?v=0.10.888',
  './js/ui/viewport-clamp.js?v=0.10.888',
  './js/ui/meal-time-message.js?v=0.10.888',
  './js/ui/loose-shape-label.js?v=0.10.888',
  './js/ui/rough-display-name.js?v=0.10.888',
  './js/ui/time-remaining-label.js?v=0.10.888',
  './js/ui/workshop-staff-quality-description.js?v=0.10.888',
  './js/ui/workshop-loose-display-name.js?v=0.10.888',
  './js/ui/metal-market-date-label.js?v=0.10.888',
  './js/ui/metal-price-date-label.js?v=0.10.888',
  './js/ui/phone-item-effect-text.js?v=0.10.888',
  './js/ui/save-diagnostic-date-label.js?v=0.10.888',
  './js/ui/save-diagnostic-bytes-label.js?v=0.10.888',
  './js/ui/save-diagnostic-capacity-label.js?v=0.10.888',
  './js/ui/birthday-japanese-label.js?v=0.10.888',
  './js/ui/game-date-label.js?v=0.10.888',
  './js/ui/finance-row-date-label.js?v=0.10.888',
  './js/ui/notification-date-label.js?v=0.10.888',
  './js/ui/customer-preference-label.js?v=0.10.888',
  './js/ui/customer-template-text.js?v=0.10.888',
  './js/ui/store-display-name.js?v=0.10.888',
  './js/ui/artisan-title.js?v=0.10.888',
  './js/ui/loose-display-label.js?v=0.10.888',
  './js/ui/install-status-text.js?v=0.10.888',
  './js/ui/metal-weight-label.js?v=0.10.888',
  './js/japan-holidays.js', './js/firebase-config.js',
  './js/google-auth-bridge.js?v=0.10.888', './js/security-config.js', './js/firebase-service.js?v=0.10.888', './js/local-save-storage.js?v=0.10.888',
