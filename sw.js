...
const CORE_SHELL = [
  ...
  './manifest.webmanifest', './js/app.js', './js/audio.js?v=0.10.745', './js/audio-scene-map.js?v=0.10.745', './js/game-data.js', './js/memories-screen.js?v=0.10.745', './js/memories-backgrounds.js?v=0.10.745', './js/daily-gems-index.js?v=0.10.691',
  './js/japan-holidays.js', './js/firebase-config.js',
  './js/google-auth-bridge.js?v=0.10.745', './js/security-config.js', './js/firebase-service.js?v=0.10.745',
