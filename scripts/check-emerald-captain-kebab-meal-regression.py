...
checks = {
    ...
    'purchase result timer releases before stage check': 'emeraldCaptainPurchaseResultTimer = null;' in purchase_scheduler and purchase_scheduler.index('emeraldCaptainPurchaseResultTimer = null;') < purchase_scheduler.index("e.stage!=='purchaseResult'"),
    ...
    'meal watchdog releases before completion': 'emeraldCaptainMealWatchdogTimer = null;' in meal_watchdog and meal_watchdog.index('emeraldCaptainMealWatchdogTimer = null;') < meal_watchdog.index("e.stage==='eating'"),
