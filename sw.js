...
const APP_SHELL = [
  ...
  './manifest.webmanifest', './js/app.js', './js/audio.js', './js/audio-scene-map.js', './js/game-data.js', './js/kaitenzushi-embedded.js?v=0.10.564', './js/daily-gems.js?v=0.10.564', './js/japan-holidays.js', './js/firebase-config.js', './js/google-auth-bridge.js',
  ...
  './assets/images/events/gray-hood-aquarium.png', './assets/images/events/aquarium-tank.png', './assets/minigames/aquarium/index.html', './assets/minigames/aquarium/aquarium_config.json', './assets/minigames/aquarium/aquarium_initial_state.json', './assets/minigames/aquarium/aquarium_state_manager.js', './assets/minigames/aquarium/assets/fish/black_molly.png',
...
const CORE_SHELL = [
  ...
  './js/kaitenzushi-embedded.js?v=0.10.564', './js/daily-gems.js?v=0.10.564', './js/japan-holidays.js', './js/firebase-config.js',
