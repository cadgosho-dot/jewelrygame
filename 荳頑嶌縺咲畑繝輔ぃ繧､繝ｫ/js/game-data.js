...
export const APP_NAME = 'JEWELRY×JEWELRY';
export const APP_URL = 'https://cadgosho-dot.github.io/jewelrygame/';
...
export function defaultState() {
  ...
  return {
    ...
    notifications: [
      {
        id: crypto.randomUUID(), sender: 'システム', title: 'JEWELRY×JEWELRYへようこそ',
