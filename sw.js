...
const CORE_SHELL = [
  './', './index.html', './game.html', './auth.html', './auth-cache-recovery.js?v=0.10.776', './hosting-origin-guard.js', './viewport-shell.css', './viewport-shell.js', './styles.css',
  './manifest.webmanifest', './js/app.js?v=0.10.776', './js/audio.js?v=0.10.776', './js/audio-scene-map.js?v=0.10.776', './js/game-data.js?v=0.10.776', './js/memories-screen.js?v=0.10.776', './js/memories-backgrounds.js?v=0.10.776', './js/daily-gems-index.js?v=0.10.691',
  './js/japan-holidays.js', './js/firebase-config.js',
  './js/google-auth-bridge.js?v=0.10.776', './js/security-config.js', './js/firebase-service.js?v=0.10.776', './js/local-save-storage.js?v=0.10.776',
