...
const CORE_SHELL = [
  './', './index.html', './game.html', './auth.html', './auth-cache-recovery.js?v=0.10.876', './hosting-origin-guard.js', './viewport-shell.css', './viewport-shell.js', './styles.css',
  './manifest.webmanifest', './quiz-event-v2.css?v=0.10.876', './js/app.js?v=0.10.876', './js/runtime/lazy-modules.js?v=0.10.876', './js/runtime/finished-video-cache-warm.js?v=0.10.876', './js/ui/winter-cold-text-effect.js?v=0.10.876', './js/ui/toast-presenter.js?v=0.10.876', './js/ui/modal-presenter.js?v=0.10.876', './js/ui/autosave-status-presenter.js?v=0.10.876', './js/ui/clipboard-fallback.js?v=0.10.876', './js/ui/gift-labels.js?v=0.10.876', './js/ui/craft-surface.js?v=0.10.876', './js/ui/press-hold-controller.js?v=0.10.876', './js/audio.js?v=0.10.876', './js/audio-scene-map.js?v=0.10.876', './js/game-data.js?v=0.10.876', './js/memories-screen.js?v=0.10.876', './js/memories-backgrounds.js?v=0.10.876', './js/daily-gems-index.js?v=0.10.876',
  './js/ui/tool-brief.js?v=0.10.876',
  './js/ui/store-branch-label.js?v=0.10.876',
  './js/ui/viewport-clamp.js?v=0.10.876',
  './js/ui/meal-time-message.js?v=0.10.876',
  './js/ui/loose-shape-label.js?v=0.10.876',
  './js/ui/rough-display-name.js?v=0.10.876',
  './js/ui/time-remaining-label.js?v=0.10.876',
  './js/ui/workshop-staff-quality-description.js?v=0.10.876',
  './js/ui/workshop-loose-display-name.js?v=0.10.876',
  './js/ui/metal-market-date-label.js?v=0.10.876',
  './js/ui/metal-price-date-label.js?v=0.10.876',
  './js/ui/phone-item-effect-text.js?v=0.10.876',
  './js/ui/save-diagnostic-date-label.js?v=0.10.876',
  './js/ui/metal-weight-label.js?v=0.10.876',
  './js/japan-holidays.js', './js/firebase-config.js',
  './js/google-auth-bridge.js?v=0.10.876', './js/security-config.js', './js/firebase-service.js?v=0.10.876', './js/local-save-storage.js?v=0.10.876',
