...
RULES = [
    ...
    Rule('sw.js', 'display-shop.js precache key', qparam(r'\./js/store/display-shop\.js'), keep_prefix),
    ...
    Rule('js/app.js', 'display-shop.js import key', qparam(r'\./store/display-shop\.js'), keep_prefix),
