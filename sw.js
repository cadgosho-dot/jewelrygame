...
const CORE_SHELL = [
  './', './index.html', './game.html', './auth.html', './auth-cache-recovery.js?v=0.10.855', './hosting-origin-guard.js', './viewport-shell.css', './viewport-shell.js', './styles.css',
  './manifest.webmanifest', './quiz-event-v2.css?v=0.10.855', './js/app.js?v=0.10.855', './js/runtime/lazy-modules.js?v=0.10.855', './js/runtime/finished-video-cache-warm.js?v=0.10.855', './js/ui/press-hold-controller.js?v=0.10.855', './js/audio.js?v=0.10.855', './js/audio-scene-map.js?v=0.10.855', './js/game-data.js?v=0.10.855', './js/memories-screen.js?v=0.10.855', './js/memories-backgrounds.js?v=0.10.855', './js/daily-gems-index.js?v=0.10.855',
  './js/japan-holidays.js', './js/firebase-config.js',
  './js/google-auth-bridge.js?v=0.10.855', './js/security-config.js', './js/firebase-service.js?v=0.10.855', './js/local-save-storage.js?v=0.10.855',
