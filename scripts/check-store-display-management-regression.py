...
checks += [
    ...
    ('dynamic harness lists install', "'installDisplayProduct'," in TEST),
    ('dynamic harness lists place item', "'placeItem'," in TEST),
    ('dynamic harness lists exact slot', "'placeItemInShowcaseSlot'," in TEST),
    ('dynamic harness lists remove', "'removeShowcase'," in TEST),
    ('dynamic harness lists move', "'moveShowcaseItem'," in TEST),
