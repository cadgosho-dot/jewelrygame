...
const APP_SHELL = [
  ...
  './manifest.webmanifest', './js/app.js', './js/audio.js', './js/game-data.js', './js/daily-gems.js?v=0.10.418', './js/japan-holidays.js', './js/firebase-config.js', './js/google-auth-bridge.js',
