...
checks = [
    ...
    ('order ring has extra 84px top clearance', '.completion-jewelry-preview.item-ring' in order_style and 'padding-top: 100px !important;' in order_style),
    ('order ring with loose has 100px top clearance', '.completion-jewelry-preview.item-ring:has(.jewelry-preview-loose)' in order_style and 'padding-top: 84px !important;' in order_style),
    ('normal completion safety remains unchanged', 'padding: 10px 0 0 !important;' in normal_style),
    ('portrait ring completion has 72px top clearance', 'body[data-screen="completion"] .result-card>.completion-jewelry-preview.item-ring{' in css and 'padding-top:88px!important;' in css),
    ...
    ('portrait ring with loose has extra 88px top clearance', '.completion-jewelry-preview.item-ring:has(.jewelry-preview-loose)' in css and 'padding-top:72px!important;' in css),
]
failed=[]
