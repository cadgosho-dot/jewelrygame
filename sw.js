...
const APP_SHELL = [
  ...
  './manifest.webmanifest', './js/app.js', './js/audio.js', './js/audio-scene-map.js', './js/game-data.js', './js/daily-gems.js?v=0.10.457', './js/japan-holidays.js', './js/firebase-config.js', './js/google-auth-bridge.js',
  ...
  './assets/images/tools/placeholder.svg', './assets/images/tools/jewelry-bench.png', './assets/images/tools/loupe.png', './assets/images/tools/gem-polishing-machine.png', './assets/images/tools/diamond-polishing-lap.png', './assets/images/tools/pliers.png', './assets/images/tools/torch.png', './assets/images/tools/bench-peg.png', './assets/images/tools/graver.png', './assets/images/tools/rotary-tool.png', './assets/images/tools/ultrasonic-cleaner.png', './assets/images/tools/piercing-saw.png', './assets/images/tools/nipper.png', './assets/images/tools/electronic-scale.png', './assets/images/tools/wood-block.png', './assets/images/tools/rolling-mill.png', './assets/images/tools/milgrain-tool.png', './assets/images/tools/dividers.png', './assets/images/tools/file.png', './assets/images/tools/hammer.png', './assets/images/tools/magnifier.png', './assets/images/tools/engraving-block.png', './assets/images/tools/stamps.png', './assets/images/tools/buffer.png', './assets/images/events/indian-restaurant-manager.png', './assets/images/robbery-newspaper.webp', './assets/images/equipment/basic-pickaxe.png', './assets/images/customers/customer-placeholder.svg',
