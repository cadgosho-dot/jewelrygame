...
checks = {
    ...
    'プレイヤー名維持': 'playerName: retroBattleStateAdapter.playerName()' in app,
    'アイテムsnapshot維持': 'inventory: retroBattleStateAdapter.inventorySnapshot()' in app,
    'アイテム同期維持': 'onInventoryChange: retroBattleStateAdapter.applyInventoryChange' in app,
