...
RULES = [
    ...
    Rule('sw.js', 'white bunny tonkatsu CSS precache key', qparam(r'\./white-bunny-tonkatsu-event\.css'), keep_prefix),
    Rule('sw.js', 'app.js precache key', qparam(r'\./js/app\.js'), keep_prefix),
    Rule('sw.js', 'white bunny tonkatsu event precache key', qparam(r'\./js/events/white-bunny-tonkatsu-event\.js'), keep_prefix),
    Rule('sw.js', 'g-Lab Kawahara game event precache key', qparam(r'\./js/events/glab-kawahara-game-event\.js'), keep_prefix),
    ...
    Rule('sw.js', 'birthday-japanese-label.js precache key', qparam(r'\./js/ui/birthday-japanese-label\.js'), keep_prefix),
    Rule('sw.js', 'game-date-label.js precache key', qparam(r'\./js/ui/game-date-label\.js'), keep_prefix),
    Rule('sw.js', 'finance-row-date-label.js precache key', qparam(r'\./js/ui/finance-row-date-label\.js'), keep_prefix),
    Rule('sw.js', 'notification-date-label.js precache key', qparam(r'\./js/ui/notification-date-label\.js'), keep_prefix),
    Rule('sw.js', 'customer-preference-label.js precache key', qparam(r'\./js/ui/customer-preference-label\.js'), keep_prefix),
    Rule('sw.js', 'customer-template-text.js precache key', qparam(r'\./js/ui/customer-template-text\.js'), keep_prefix),
    Rule('sw.js', 'store-display-name.js precache key', qparam(r'\./js/ui/store-display-name\.js'), keep_prefix),
    Rule('sw.js', 'artisan-title.js precache key', qparam(r'\./js/ui/artisan-title\.js'), keep_prefix),
    Rule('sw.js', 'loose-display-label.js precache key', qparam(r'\./js/ui/loose-display-label\.js'), keep_prefix),
    Rule('sw.js', 'install-status-text.js precache key', qparam(r'\./js/ui/install-status-text\.js'), keep_prefix),
    ...
    Rule('js/app.js', 'white bunny tonkatsu event import key', qparam(r'\./events/white-bunny-tonkatsu-event\.js'), keep_prefix),
    Rule('js/app.js', 'g-Lab Kawahara game event import key', qparam(r'\./events/glab-kawahara-game-event\.js'), keep_prefix),
    ...
    Rule('js/app.js', 'birthday-japanese-label.js import key', qparam(r'\./ui/birthday-japanese-label\.js'), keep_prefix),
    Rule('js/app.js', 'game-date-label.js import key', qparam(r'\./ui/game-date-label\.js'), keep_prefix),
    Rule('js/app.js', 'finance-row-date-label.js import key', qparam(r'\./ui/finance-row-date-label\.js'), keep_prefix),
    Rule('js/app.js', 'notification-date-label.js import key', qparam(r'\./ui/notification-date-label\.js'), keep_prefix),
    Rule('js/app.js', 'customer-preference-label.js import key', qparam(r'\./ui/customer-preference-label\.js'), keep_prefix),
    Rule('js/app.js', 'customer-template-text.js import key', qparam(r'\./ui/customer-template-text\.js'), keep_prefix),
    Rule('js/app.js', 'store-display-name.js import key', qparam(r'\./ui/store-display-name\.js'), keep_prefix),
    Rule('js/app.js', 'artisan-title.js import key', qparam(r'\./ui/artisan-title\.js'), keep_prefix),
    Rule('js/app.js', 'loose-display-label.js import key', qparam(r'\./ui/loose-display-label\.js'), keep_prefix),
    Rule('js/app.js', 'install-status-text.js import key', qparam(r'\./ui/install-status-text\.js'), keep_prefix),
