...
RULES = [
    ...
    Rule('sw.js', 'kawahara game event precache key', qparam(r'\./js/events/kawahara-game-event\.js'), keep_prefix),
    ...
    Rule('js/app.js', 'kawahara game event import key', qparam(r'\./events/kawahara-game-event\.js'), keep_prefix),
