...
const APP_SHELL = [
  ...
  './manifest.webmanifest', './js/app.js', './js/audio.js', './js/audio-scene-map.js', './js/game-data.js', './js/kaitenzushi-embedded.js?v=0.10.550', './js/daily-gems.js?v=0.10.550', './js/japan-holidays.js', './js/firebase-config.js', './js/google-auth-bridge.js',
...
const CORE_SHELL = [
  ...
  './js/kaitenzushi-embedded.js?v=0.10.550', './js/daily-gems.js?v=0.10.550', './js/japan-holidays.js', './js/firebase-config.js',
