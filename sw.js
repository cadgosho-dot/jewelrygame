...
const CORE_SHELL = [
  './', './index.html', './game.html', './auth.html', './auth-cache-recovery.js?v=0.10.864', './hosting-origin-guard.js', './viewport-shell.css', './viewport-shell.js', './styles.css',
  './manifest.webmanifest', './quiz-event-v2.css?v=0.10.864', './js/app.js?v=0.10.864', './js/runtime/lazy-modules.js?v=0.10.864', './js/runtime/finished-video-cache-warm.js?v=0.10.864', './js/ui/winter-cold-text-effect.js?v=0.10.864', './js/ui/toast-presenter.js?v=0.10.864', './js/ui/modal-presenter.js?v=0.10.864', './js/ui/autosave-status-presenter.js?v=0.10.864', './js/ui/clipboard-fallback.js?v=0.10.864', './js/ui/gift-labels.js?v=0.10.864', './js/ui/craft-surface.js?v=0.10.864', './js/ui/press-hold-controller.js?v=0.10.864', './js/audio.js?v=0.10.864', './js/audio-scene-map.js?v=0.10.864', './js/game-data.js?v=0.10.864', './js/memories-screen.js?v=0.10.864', './js/memories-backgrounds.js?v=0.10.864', './js/daily-gems-index.js?v=0.10.864',
  './js/ui/tool-brief.js?v=0.10.864',
  './js/ui/store-branch-label.js?v=0.10.864',
  './js/japan-holidays.js', './js/firebase-config.js',
  './js/google-auth-bridge.js?v=0.10.864', './js/security-config.js', './js/firebase-service.js?v=0.10.864', './js/local-save-storage.js?v=0.10.864',
