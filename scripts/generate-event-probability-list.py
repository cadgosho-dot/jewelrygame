...
GLAB_KAWAHARA_GAME_MODULE = ROOT / 'js' / 'events' / 'glab-kawahara-game-event.js'
...
EVENT_GROUPS = [
    ...
    ('店舗・g-Lab.・工房', [
        ...
        ('GLAB_KAWAHARA_GAME_EVENT_CHANCE', 'カワハラ・ゲーム制作', '300日目以降・未完了・1回限定のg-Lab.入店時'),
...
def generate() -> str:
    ...
    kawahara_game_exprs, _ = constants(GLAB_KAWAHARA_GAME_MODULE.read_text(encoding='utf-8'))
    exprs['GLAB_KAWAHARA_GAME_EVENT_CHANCE'] = kawahara_game_exprs['GLAB_KAWAHARA_GAME_EVENT_CHANCE']
    source_paths['GLAB_KAWAHARA_GAME_EVENT_CHANCE'] = 'js/events/glab-kawahara-game-event.js'
