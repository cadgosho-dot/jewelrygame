...
def main() -> None:
    ...
    require("import './wolf-boy-ring-event.js?v=0.10.941';" in bootstrap, 'イベント起動口が本体を読み込んでいません')
    require('wolf-boy-ring-event-hotfix' not in bootstrap, 'event-bootstrap に hotfix 参照が残っています')
    require("import './event-bootstrap.js?v=0.10.941';" in memories_bg, '既存の起動経路からイベント起動口が読み込まれていません')
